		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsharpacntsummary-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsharpacntsummary-display": {
								"semanticObject": "comsharpacntsummary",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sharp.acntsummary",
									"url": sap.ui.require.toUrl("com/sharp/acntsummary")
								}
							}
						}
					}
